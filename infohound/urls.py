...
urlpatterns = [
    ...
    path('export_domain_graphml/<int:domain_id>', views.export_to_graphml, name='export_to_graphml'),
    path('export_domain_csv/<int:domain_id>', views.export_all_to_CSV, name='export_all_to_CSV'),
